...
#Region "全局变量"
    ...
    Public CpuUsage As Integer = 0
    Public RamUsage As Integer = 0
    Public _process As Process
    Public _MemoryWorkStop As Boolean
    Public _CpuWorkStop As Boolean
    Public myBatFilePath = Path.Combine(My.Computer.FileSystem.SpecialDirectories.Temp, "restart.bat")
    Public workerThread1 As New Thread(AddressOf CpuMemoryCapacity.DoMemoryWork)
    Public workerThread2 As New Thread(AddressOf CpuMemoryCapacity.DoCpuWork)
